...
These are direct call sites. Indirect reader/writer ownership must be reconciled during human review.
...
- `ANDROID_HOME_SERVER_STATE_KEYS`: `hasDSSHW`
- `ANDROID_SHARED_SERVER_STATE_KEYS`: `androidVersion`, `battery`, `battery_low`, `battery_state`, `brand`, `fcm_token`, `fcm_token_at`, `heartbeat_interval_ms`, `ip`, `version`
...
- `MATTER_SERVER_STATE_KEYS`: `source`
- `OTHER_SERVER_STATE_KEYS`: `battery`, `battery_low`, `battery_state`, `brand`, `ip`, `manufacturer`, `model`, `source`, `version`
- `SERVER_CLIENT_STATE_KEYS_BY_GROUP`: `android_home`, `android_key`, `matter`, `other`, `tapo`, `unprovisioned`
...
- `TAPO_SERVER_STATE_KEYS`: `source`
- `UNPROVISIONED_SERVER_STATE_KEYS`: `androidVersion`, `battery`, `battery_low`, `battery_state`, `brand`, `detectedRole`, `fcm_token`, `fcm_token_at`, `hasDSSHW`, `heartbeat_interval_ms`, `ip`, `manufacturer`, `model`, `source`, `version`
